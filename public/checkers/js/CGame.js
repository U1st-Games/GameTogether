function CGame(oData){
    ...
    this._init = function(){
        ...
        var oAnimationContainer = new createjs.Container();
        s_oStage.addChild(oAnimationContainer);
        ...
        new CStartAnimation(_oDrawContainer, _aWhitePos, _aBlackPos, oAnimationContainer);
    };
